...
namespace Utilities.IO
{
    public interface IFileInfo : IFileSystemInfo
    {
        ...
        ///     version="1" Unrestricted="true" />
        /// </PermissionSet>
        IFileInfo Replace(string destFileName, string destBackupFileName);
        ...
        ///     version="1" Unrestricted="true" />
        /// </PermissionSet>
        IFileInfo Replace(string destFileName, string destBackupFileName, bool ignoreMetadataErrors);
    }
}