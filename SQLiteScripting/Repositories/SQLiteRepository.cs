...
{
    //uses sqlite-netFx40-static-binary-bundle-Win32-2010-1.0.92.0
...
//TODO Enumerate SQLite views and triggers
//•Views
//•ViewColumns
//•Triggers
        ...
        public List<Column> GetAllColumns()
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                col.ColumnDefault = dt.Rows[i]["NUMERIC_PRECISION"].GetType() != typeof(System.DBNull) ? null : dt.Rows[i]["COLUMN_DEFAULT"].ToString();
        ...
        public System.Data.IDataReader GetDataFromReader(string tableName, List<Column> tableColumns, List<PrimaryKey> tablePrimaryKeys)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder(200);
            sb.Append("SELECT ");
            foreach (Column col in tableColumns)
        ...
        public System.Data.DataSet ExecuteSql(string script, out string showPlanString, out bool schemaChanged, bool ignoreDDLErrors)
        {
            schemaHasChanged = false;
            DataSet ds = null;
            try
                ...
                using (StringReader reader = new StringReader(script))
                {
                    ...
                    while ((line = reader.ReadLine()) != null)
                    {
                        ...
                        if (line.Equals("GO", StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            RunCommand(sql, dataset, ignoreDDLErrors);
