...
{
    public class MySqlSchemaTreeNode : SchemaTreeNode
    {
        public MySqlSchemaTreeNode(Schema schema, DatabaseConnection databaseConnection, DatabaseInstance databaseInstance)
