...
namespace ErikEJ.SqlCeScripting
{
...
#endif
    {
        ...
        public DataSet ExecuteSql(string script, out string showPlanString, out bool schemaChanged, bool ignoreDDLErrors)
        {
            schemaHasChanged = false;
            DataSet ds = null;
            try
            {
                ds = new DataSet();
                RunCommands(ds, script, false, true, ignoreDDLErrors);
                showPlanString = showPlan;
                schemaChanged = schemaHasChanged;
            }
            catch
