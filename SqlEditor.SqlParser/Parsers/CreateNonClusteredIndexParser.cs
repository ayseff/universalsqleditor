        ...
        private Dictionary<string, IndexWithOption> _optionMap = new Dictionary<string, IndexWithOption>
                                                                     {
                                                                         ...
                                                                         {
                                                                             Constants.SortInTempDb,
                                                                             IndexWithOption.SortInTempDb
                                                                             },
                                                                         {
                                                                             Constants.IgnoreDupKey,
                                                                             IndexWithOption.IgnoreDupKey
                                                                             },
                                                                         {
                                                                             Constants.StatisticsNorecompute,
                                                                             IndexWithOption.StatisticsNorecompute
                                                                             },
                                                                         {
                                                                             Constants.DropExisting,
                                                                             IndexWithOption.DropExisting
                                                                             },
                                                                         {Constants.Online, IndexWithOption.Online},
                                                                         {
                                                                             Constants.AllowRowLocks,
                                                                             IndexWithOption.AllowRowLocks
                                                                             },
                                                                         {
                                                                             Constants.AllowPageLocks,
                                                                             IndexWithOption.AllowPageLocks
                                                                             }
                                                                     };
